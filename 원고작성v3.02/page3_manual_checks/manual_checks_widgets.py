...
class ManualChecksPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.main_splitter.addWidget(self.files_list_widget, 2)
        self.main_splitter.addWidget(self.files_content_edit, 6)
        self.main_splitter.addWidget(self.info_container, 2)
